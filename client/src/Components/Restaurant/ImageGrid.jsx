...
const ImageGrid = (props) => {
    return (
       <>
                 {/* -------------mobile device------------------- */}
                 <div className="w-full h-60 md:hidden  pt-6">
           ...
           <div className="w-full h-full relative">
              <img src={props.images[3]}
                ...
                {/* --------------sub image 4 with view gallery ------------- */}
           <div className="w-full h-full relative">
              <img src={props.images[4]}
                   alt="restaurant image"
                    className="w-full h-full rounded-lg object-cover"/>
                    <div className="absolute inset-0 bg-opacity-90 bg-gray-700 w-full h-full rounded-lg"/>
