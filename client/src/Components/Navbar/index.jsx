...
return(
    <>
 <div className=" hidden w-full items-center md:flex gap-3">
    <div className="w-24">
    <img src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png"
         alt ="logo"  className="w-full h-full"/>
    </div> 
    <div className="w-full bg-white shadow-md p-3 border border-gray-200 rounded-md flex items-center gap-3">
